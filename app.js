...
window.addEventListener('scroll', ()=>{
    ...
    if(value > 1000 && value < 1300){
        r.style.marginRight = (value-1000) * 2.2 + 'px';
        r.style.marginTop = (value-1000) * 1.8 + 'px';

        a.style.marginRight = (value-1000) * 1.2 + 'px';
        ...
        h.style.marginRight = (value-1000) * -0.5 + 'px';
        h.style.marginTop = (value-1000) * 0.4 + 'px';

        i.style.marginRight = (value-1000) * -1.2 + 'px';
        i.style.marginTop = (value-1000) * -1.1 + 'px';

        t.style.marginRight = (value-1000) * -2.2 + 'px';
    ...
    if(value > 1300 && value < 1950){
        r.style.marginTop = (por)+((value-1300) * 2.4) + 'px';
        a.style.marginTop = (poa)+((value-1300) * 3.748) + 'px';
        c.style.marginTop = (poc)+((value-1300) * 2.75) + 'px';
        h.style.marginTop = (poh)+((value-1300) * 3.04) + 'px';
        i.style.marginTop = (poi)+((value-1300) * 3.748) + 'px';
        t.style.marginTop = (pot)+((value-1300) * 2.4) + 'px';
    }
})
